...
\subsection{Intearction with the smart contracts: Backend}
\subsubsection{$Web3.py: Brownie$}
\subsubsection{$Testing: pytest$}
\subsection{Interaction with the users: Frontend}
\subsubsection{$Ethers.js: wagmi$}
\subsubsection{$Next.js$}
\subsubsection{$Testing: mochajs$}
%%%%%
%%%%% Chapter
