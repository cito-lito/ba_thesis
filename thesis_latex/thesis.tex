...
\newcommand{\titel}{Study and Implementation of a Decentralized Application That Can Provide Permissionless Financial Services Using an EVM Based Blockchain}
%\newcommand{\kurztitel}{Template Abschlussarbeit}
\newcommand{\autor}{Mario Alberto Maita Orozco}
\newcommand{\datum}{28.06.2022} % Abgabedatum
...
%\subsubsection{Deposit}
%an ERC20 contract instance and check the balance of the user account. If the inserted amount is correct, the deposit action can continue.
%The thesis dapp will start the "approve" transaction and wait for the user to sign it. Next, get the pool address to create the pool contract, and start the deposit or supply transaction. Once the user %has signed the deposit transaction, and the transaction is processed, the deposit action will be finished.
%\begin{figure}[htp]
%	\centering
