...
\begin{itemize}
	...
	\item{\textbf{Repay:}} The \verb|repay()| function allows accounts to pay back borrowed assets by burning the specific debt tokens, reducing or removing the debt of the account address passed in the \verb|onBehalfOf| parameter. 	
\end{itemize}
