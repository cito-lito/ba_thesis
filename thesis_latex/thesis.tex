...
\begin{figure}[htp]
	\centering
	\includegraphics[width=1.05\textwidth]{./images/thesis-dapp}
...
await tx_deposit.wait();
	...
\end{lstlisting}
Note that the amount is passed to the contract instances in the form of Wei~\ref{sec:gas} using ethers~\ref{ethers}. Ultimately, the withdraw, borrow, and repay functionalities follow the same pattern.
