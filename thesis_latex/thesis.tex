...
The first interaction with the smart contracts of Aave was done using the brownie framework. However, in order to let other accounts (users), interact with these smart contracts a frontend with a wallet is needed.
\section{Interaction with the users}
\subsection{Next.js}
\subsection{Ethers.js: web3 react hooks}
